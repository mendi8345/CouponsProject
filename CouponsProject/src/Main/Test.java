...
public class Test {
	...
	public static void main(String[] args) throws Exception {
		...
		Company company1 = new Company(1, " super pharm", "4211", "superpharm@java.com");
		...
		Coupon coupon1 = new Coupon(1, "falafel", DateUtils.GetCurrentDate(), DateUtils.GetEndDate(), 600, "electric",
